...
def run_experiment(input_path, protocol_path, study_protocol_path):
    ...
    report = {
        ...
        "protocol": {"path": str(protocol_path), "sha256": digest(protocol_raw),
                     "frozen_status": protocol["status_of_this_file"]},
        "input": {"path": str(input_path), "sha256": digest(input_path.read_bytes())},
        "study_protocol": {"path": str(study_protocol_path),
