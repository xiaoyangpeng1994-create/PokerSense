...
- **2026-09-17 — USABLE-001 P1 PHH + PokerKit SHADOW ORACLE (first round: bypass/differential only):**
  ...
  source of truth for the doc), `tests/desktop/test_aa_phh_shadow.py` (**24 tests, all passing, flake8
  clean**) and `docs/research/pokersense-phh-pokerkit-shadow-oracle.zh-CN.md` (the required
