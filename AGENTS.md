...
6. Use `docs/PR-WORKFLOW.zh-CN.md` for authorized development. The canonical
   remote is the private `xiaoyangpeng1994-create/PokerSense`; treat
...
- **2026-09-14 PRIVATE CANONICAL REPOSITORY + PR WORKFLOW:** Created independent
  private `xiaoyangpeng1994-create/PokerSense` (not a fork), with local committed
  baseline eb4011172adec280c99cd442ca49e9083ce9ec8b on main. Local `origin`
  targets the private repository; `windgeek-base` retains the earliest public
